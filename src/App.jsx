...
export const FRAMEWORK = {
  themes: [
    ...
    },
    {
      ...
      metrics: [
        { id: "mkt_size", name: "Market Size & Growth Potential", question: "How large is your total addressable market and what is its projected growth rate?", weight: 25, foundational: "Small maximum market (less than $500m)", evolving: "Medium maximum market ($500m-1bn)", optimised: "Large maximum market (>$1bn)", guidance: "Addressable market size should be clearly defined and large enough for growth ambitions. Document TAM, SAM, and SOM with credible bottom-up analysis." , improvementAction: "Define total addressable market, track market share trends, and identify growth white spaces" },
