      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="text-center mb-10">
          <div className="w-32 h-32 sm:w-36 sm:h-36 rounded-full border-4 border-amber-400 shadow-lg mx-auto mb-5 overflow-hidden">
            <img src="https://richardgoold.com/wp-content/uploads/2025/08/hero.webp" alt="Richard Goold" className="w-full h-full object-cover" style={{ objectFit: 'cover', objectPosition: 'center bottom' }} />
          </div>
