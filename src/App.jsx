...
import { Building2, ClipboardCheck, LayoutDashboard, Plus, ChevronRight, CheckCircle2, Circle, AlertCircle, Home, TrendingUp, Target, Award, MessageSquare, ArrowLeft, Trash2, Download, FileText, BarChart3, Copy, X , Info, HelpCircle, Target, TrendingUp as TrendUp } from "lucide-react";
  ...
  themes: [
    ...
    },
    {
      ...
      metrics: [
        ...
        { id: "cos_lever", name: "Leverage", question: "What is your use of AI and Automation?", weight: 0, foundational: "Leverage ratio >3.5x EBITDA, high debt burden", evolving: "Leverage ratio 2.0-3.5x EBITDA, manageable debt", optimised: "Leverage ratio <2.0x EBITDA, strong financial flexibility", guidance: "Leverage in a PSF context means the ratio of junior to senior staff on projects. Higher leverage with maintained quality indicates scalable, profitable delivery." },
    ...
    },
    {
      ...
      metrics: [
        { id: "mkt_size", name: "Market Size & Growth Potential", question: "How clearly defined and executed is your branding strategy?", weight: 25, foundational: "Small maximum market (less than $500m)", evolving: "Medium maximum market ($500m-1bn)", optimised: "Large maximum market (>$1bn)", guidance: "Addressable market size should be clearly defined and large enough for growth ambitions. Document TAM, SAM, and SOM with credible bottom-up analysis." },
        { id: "mkt_mktg", name: "Marketing Influence on Revenue", question: "What percentage of your revenue is directly influenced by marketing activities?", weight: 50, foundational: "<5% of revenue influenced by marketing", evolving: "5-15% of revenue influenced by marketing", optimised: "15%+ of revenue driven by marketing", guidance: "Marketing effectiveness is measured by lead generation metrics, brand awareness, share of voice, and marketing-attributed pipeline. Track cost per qualified lead." },
        { id: "mkt_award", name: "Awards & Recognition", question: "How many national or industry awards have you won in the past three years?", weight: 50, foundational: "No national or industry awards won in the past three years", evolving: "1-2 national or industry awards won in the past three years", optimised: "3+ national or industry awards, with external validation from major industry bodies", guidance: "Industry awards and recognition validate market positioning. Active award submissions, analyst relations, and industry body participation demonstrate thought leadership." },
...
const calcScores = (ratings) => {
  ...
  FRAMEWORK.themes.forEach(theme => {
    ...
    FRAMEWORK.themes.forEach(theme => {
      ...
      const benchPct = BENCHMARKS[theme.id] || 65;
...
const exportToPDF = (assessment, firmName, firmSector, scores) => {
  ...
  const benchmarkData = BENCHMARKS[sectorKey] || {};
...
const exportExecutiveSummary = (assessment, firmName, firmSector, scores) => {
  ...
  const themeGridHtml = FRAMEWORK.themes.map(t => {
    ...
    const bench = BENCHMARKS[t.id] || 65;
...
function DashboardView({ assessment, firmName, firmSector, onBack, firmAssessments }) {
  const scores = calcScores(assessment.ratings);
