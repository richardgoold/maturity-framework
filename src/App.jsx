    ...
    <div className="flex-1 overflow-auto">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="text-center mb-10">
          <div className="w-32 h-32 sm:w-36 sm:h-36 rounded-full border-4 border-amber-400 shadow-lg mx-auto mb-4" style={{ backgroundImage: 'url(https://richardgoold.com/wp-content/uploads/2025/08/hero.webp)', backgroundSize: '280%', backgroundPosition: '48% 22%' }} />
