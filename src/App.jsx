...
<div style="margin-top:30px;padding:16px 20px;background:#f8f9fa;border:1px solid #e5e7eb;border-radius:8px;page-break-inside:avoid">
  ...
  <div style="font-size:11px;color:#4b5563;line-height:1.5">This report was generated by the Growth Drivers Maturity Framework. For a detailed review of these findings and a tailored improvement roadmap, contact <strong>richard@richardgoold.com</strong></div>
  ...
  return (
    <div className="h-screen flex flex-col bg-[#f9f9f9]" style={{ fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      <header className="px-4 py-2.5 flex items-center justify-between flex-shrink-0" style={{ background: "#1f1f1f", borderBottom: "2px solid #f2a71b" }}>
        ...
        <button className="md:hidden p-2 rounded-lg text-gray-300 hover:bg-white/10" onClick={() => setMobileMenuOpen(m => !m)}>
              ...
              <div className="bg-gray-900 rounded-2xl p-8 sm:p-12 text-center shadow-xl border border-gray-800">
                <div className="flex flex-col-reverse sm:flex-row items-center justify-between gap-6 mb-8">
                  ...
                  <div className="w-40 h-40 sm:w-52 sm:h-52 rounded-full border-4 border-amber-400 shadow-lg flex-shrink-0 overflow-hidden">
                    <img src="https://richardgoold.com/wp-content/uploads/2025/08/hero.webp" alt="Richard Goold" className="w-full h-full object-cover" style={{objectPosition: '48% 25%', transform: 'scale(1.50)'}} />
                  </div>
                </div>
                <div className="mb-8">
